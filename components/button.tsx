...
export default function Button({
  ...
  const baseClasses =
    "transition inline-flex items-center justify-center gap-2 rounded-full font-medium tracking-wide cursor-pointer shadow-medium outline-hidden shrink-0 text-nowrap focus-visible:ring-[3px] focus-visible:ring-green-400/40 focus-visible:ring-offset-1 focus-visible:ring-offset-white focus-visible:outline-hidden";
